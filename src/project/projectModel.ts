...
export type SceneTrack = {
  id: string;
  name: string;
  kind: 'video' | 'audio' | 'character' | 'camera' | 'effect';
};
...
// QA/compatibility invariants: the studio scene model exposes stable dimension aliases
// while retaining the width/height fields used by the renderer and existing projects.
