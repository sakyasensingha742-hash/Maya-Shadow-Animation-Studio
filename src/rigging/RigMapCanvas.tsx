...
{id:'l-knee',label:'L Knee',x:43,y:76,group:'body'},{id:'r-knee',label:'R Knee',x:57,y:76,group:'body'},{id:'l-foot',label:'L Foot',x:40,y:94,group:'body'},{id:'r-foot',label:'R Foot',x:60,y:94,group:'body'},
...
export default function RigMapCanvas({image}:Props){
 ...
 return <section className="rig-map-panel">
  ...
  <div className="rig-map-stage">
   ...
   <svg className="rig-bones" viewBox="0 0 100 100" preserveAspectRatio="none">{bones.map(([a,b])=>{const p1=pointById(a),p2=pointById(b);return <line key={a+b} x1={p1.x} y1={p1.y} x2={p2.x} y2={p2.y}/>})}</svg>
